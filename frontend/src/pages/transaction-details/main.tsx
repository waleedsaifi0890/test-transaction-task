...
const [transactionDetails,setTransactionDetails]=useState<TransactionArray>()
  ...
  return (
    <React.Fragment>
      <title>SyllAI - Class Details</title>
      <Layout
        isButton={false}
        isDefferent={false}
...
<div>
   <div className='ms:ms:mx-4    mt-10 border  bg-gray-100'>
          ...
          <p className='text-sm ml-2'>10/27/2023</p>
          </div>
        ...
        <div className='p-5 flex justify-between border-b items-end '>
          ...
          <p className='text-sm ml-2'>{transactionDetails?.isAllowed===true?"True":"False"}</p>
          </div>
          <div className='p-5 flex justify-between border-b items-end '>
          <p className='font-semibold'>Suspicious</p>
          <p className='text-sm ml-2'>{transactionDetails?.isSuspicious===true?"True":"False"}</p>
          </div>
          <div className='p-5 flex justify-between border-b items-end '>
        ...
        <div className='   border  bg-gray-100 rounded-md'>
          ...
          <div className='p-5 flex justify-between border-b items-end '>
          <p className='font-normal text-sm'>{transactionDetails?.description}</p>
          </div>
        ...
        <div className='   border  bg-gray-100 rounded-md'>
          ...
          <div className='p-5 flex justify-between border-b items-end '>
          <p className='font-normal text-sm'>{transactionDetails?.comment}</p>
          </div>
